...
import org.ungs.gorgory.config.audit.AuditEventConverter;
import org.ungs.gorgory.domain.PersistentAuditEvent;
...
import static org.ungs.gorgory.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
